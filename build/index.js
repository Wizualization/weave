...
const VERSION = "1.0.0";
const DEFAULT_PORT = (config_1.default === null || config_1.default === void 0 ? void 0 : config_1.default.port) | 8443;
// Commander setup
commander_1.default
...
const CLIENT_PORT = commander_1.default.dev ? 8443 : commander_1.default.port;
// Express setup
...
exports.io = require("socket.io")(server, {
    ...
    cors: {
        origin: [
            `http://localhost:${commander_1.default.dev ? 8443 : DEFAULT_PORT}`,
